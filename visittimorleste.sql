...
--
-- Host: localhost
-- Generation Time: Aug 11, 2021 at 06:20 AM
...
INSERT INTO `about` (`id_about`, `about_title`, `content`) VALUES
(1, 'testing 1234444ww', '<b>wawww</b>');
...
--
-- Table structure for table `handytips`
--

CREATE TABLE `handytips` (
  `id_handytips` int(11) NOT NULL,
  `tips_name` varchar(255) NOT NULL,
  `content` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `handytips`
--

INSERT INTO `handytips` (`id_handytips`, `tips_name`, `content`) VALUES
(1, 'tes', '<p></p><p></p><p><br></p>'),
(2, 'aaa', '<font color=\"#6a9955\"><b>waduuu</b></font>'),
(4, 'asdasd', '<p>asdasdasd</p>'),
(5, 'fghfgh', '<p>fghfghfgh</p>'),
(6, 'adsasd', '<p>aaaaaa</p>'),
(7, 'dsfdsfdsf', '<p>ewdsf</p>');
...
(2, 'aaaaaaa', 5, '2021-06-18', '2021-06-26', '<p><b>sadasd testing \"\" \'\' \'\' \'\'</b></p>', '<p>asdasd</p>', '<p>asdasd</p>', '<p>asdasd</p>');
...
(5, 'sdasdsa', 5, '2021-07-01 19:34:48', '<p>asdasdasdasdasdasd</p>', 'Screen Shot 2021-06-30 at 20.09.43.png-1625142888580-76015125.png');
...
(2, 1, 'zzzsaaasatuasd', 'satu', 'satu', 'satu', 'satu', '405ff63f-2ac8-473e-807e-495f21850af9.jpg'),
...
--
-- Table structure for table `usefulcontact`
--

CREATE TABLE `usefulcontact` (
  `id_usefulcontact` int(11) NOT NULL,
  `usefulcontact_name` varchar(255) NOT NULL,
  `content` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `usefulcontact`
--

INSERT INTO `usefulcontact` (`id_usefulcontact`, `usefulcontact_name`, `content`) VALUES
(1, 'Pemadam Kebakaran', '<p><b>Padang (081803444572)</b></p><p>Dukun (0001123455)</p>'),
(4, 'www', '<p>wwww</p>');
...
(1, 'padangz', 'Explorer', 'Foodies | Wibu | Ginseng', 'ganteng orangnya', 'No', 'avatarpadang.jpg'),
...
--
-- Indexes for table `handytips`
--
ALTER TABLE `handytips`
  ADD PRIMARY KEY (`id_handytips`);
...
--
-- Indexes for table `usefulcontact`
--
ALTER TABLE `usefulcontact`
  ADD PRIMARY KEY (`id_usefulcontact`);
...
--
-- AUTO_INCREMENT for table `handytips`
--
ALTER TABLE `handytips`
  MODIFY `id_handytips` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `spotlights`
  MODIFY `id_spotlights` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `usefulcontact`
--
ALTER TABLE `usefulcontact`
  MODIFY `id_usefulcontact` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
