...
function About(props) {
  return (
          ...
          <div className="main-panel" style={{height: '100vh'}}>
            <nav className="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
              <div className="container-fluid">
                <div className="navbar-wrapper">
                  ...
                  <a className="navbar-brand" href="javascript:;">About</a>
                </div>
            ...
            <div className="content">
              <div className="row" style={{margin:0}}>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addHandyTipsModal">Add About</button>




                    <form action="api/about/update" method="POST" encType="multipart/form-data" class="modal fade" id="updateHandyTipsModal" tabindex="-1" role="dialog" aria-labelledby="addToursModal" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                            ...
                            <div class="form-group" id="containerupdatetipscontent">
                                <label for="exampleFormControlInput1">About Content</label>
                    ...
                    <form action="api/about/create" method="POST" encType="multipart/form-data" class="modal fade" id="addHandyTipsModal" tabindex="-1" role="dialog" aria-labelledby="addToursModal" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                    ...
                    <div class="table-responsive"> 
                        <table id="table" class="table"> 
                            ...
                            <tbody> 
                              ...
                              {
                                props.about.map((element,index)=>{
                                  return (
                                    <tr> 
                                        <td data-id={element.id_about} id="no">{index+1}</td> 
                                        <td id="name">{element.about_title}</td> 
                                        ...
                                        <td>
                                            ...
                                            <form action={`/api/about/delete/${element.id_about}`} method="POST">
      ...
      <script src="static/assets/about.js" type="text/javascript"></script>
