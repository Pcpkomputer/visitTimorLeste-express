...
function HandyTips(props) {
  return (
          ...
          <div className="main-panel" style={{height: '100vh'}}>
            <nav className="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
              <div className="container-fluid">
                <div className="navbar-wrapper">
                  ...
                  <a className="navbar-brand" href="javascript:;">Handy Tips</a>
                </div>
            ...
            <div className="content">
              <div className="row" style={{margin:0}}>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addHandyTipsModal">Add Tips</button>




                    <form action="api/handytips/update" method="POST" encType="multipart/form-data" class="modal fade" id="updateHandyTipsModal" tabindex="-1" role="dialog" aria-labelledby="addToursModal" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Update Handy Tips</h5>
                      ...
                      <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Tips Name</label>
                    ...
                    <form action="api/handytips/create" method="POST" encType="multipart/form-data" class="modal fade" id="addHandyTipsModal" tabindex="-1" role="dialog" aria-labelledby="addToursModal" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Add Handy Tips</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                    ...
                    <div class="table-responsive"> 
                        <table id="table" class="table"> 
                            ...
                            <tbody> 
                              ...
                              {
                                props.handytips.map((element,index)=>{
                                  return (
                                    <tr> 
                                        <td data-id={element.id_handytips} id="no">{index+1}</td> 
                                        <td id="name">{element.tips_name}</td> 
                                        ...
                                        <td>
                                            ...
                                            <form action={`/api/handytips/delete/${element.id_handytips}`} method="POST">
      ...
      <script src="static/assets/handytips.js" type="text/javascript"></script>
    <script src="https://unpkg.com/bootstrap-datepicker@1.9.0/dist/js/bootstrap-datepicker.min.js"></script>
      </html>
  );
}

module.exports = HandyTips;
